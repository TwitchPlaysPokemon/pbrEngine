...
def generateDefaultAvatars():
    ...
    for char_style in random.sample(range(1, 7), 2):
        ...
        # Avatars with some randomization
        # avatar = {
        #     "CHARACTER_STYLE"    : char_style,
        #     "SKIN"      : random.randrange(2),
        #     # Muscle man has an extra head option, spiky hair. Skip it
        #     "HEAD"      : random.randint(1, 2) if char_style == 2 else random.randrange(2),
        #     "HAIR"      : 0,
        #     "FACE"      : 0,
        #     "TOP"       : random.randrange(2),
        #     # Little girl breaks if bottom isn't 0 or 1
        #     "BOTTOM"    : 0 if char_style == 6 else random.randrange(2),
        #     "SHOES"     : 0,
        #     "HANDS"     : 0,
        #     "BAG"       : 0,
        #     "GLASSES"   : 0,
