...
class Locations(Enum):
    ...
    GUI_TARGET_MATCH = Loc(0x80478498, 4)
    INPUT_MOVE       = Loc(0x8047849d, 1)
    INPUT_PKMN       = Loc(0x8047849f, 1)
    WHICH_PLAYER     = Loc(0x80478477, 1)
    ...
    GUI_STATE_MATCH  = Loc(0x80478499, 1)
    GUI_STATE_MATCH_PKMN_MENU = Loc(0x8047849b, 1)
    ...
    ORDER_BLUE       = Loc(0x8048745c, 4)  # actually 1-6
    ORDER_RED        = Loc(0x80487468, 4)  # actually 1-6
    ORDER_LOCK_BLUE  = Loc(0x80487462, 1)
    ORDER_LOCK_RED   = Loc(0x8048746e, 1)
    ...
    ANNOUNCER_FLAG   = Loc(0x8047a96d, 1)  # just in start menu

    GUI_POS_X        = Loc(0x80642350, 4)  # default be830304
    GUI_POS_Y        = Loc(0x80642354, 4)  # default 41700000
